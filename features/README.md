...
| --- | --- | --- |
| The door | `auth.feature` · `sms_otp.feature` · `invitations.feature` · `kroger_link.feature` · `onboarding.feature` | Who gets in at all, who may approve them, how a household is invited and given its own tenant and corpus, how a Kroger account is connected, and how a brand-new household's assistant gets started without a manual |
